...
# Sonoff 5
pio run -t upload -e custom-ota --upload-port 192.168.1.82
#pio run -t upload -e custom
#ESPURNA_FLAGS="-DUSE_PASSWORD=0 -DUSE_CUSTOM_H" pio run -t upload -e itead-sonoff-basic
