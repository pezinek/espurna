...
ESPURNA_FLAGS="$ESPURNA_FLAGS -DDHT_SUPPORT=1 -DDHT_PIN=14 -DBUTTON2_MODE=7 -DBUTTON2_PIN=4 -DBUTTON2_RELAY=2 -DRELAY2_PIN=2 -DRPN_RULES_SUPPORT=1" \
pio run -t upload -e wemos-d1mini-relayshield --upload-port 192.168.1.250 # /dev/ttyUSB0
